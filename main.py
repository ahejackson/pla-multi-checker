...
from app import APP_MODE, CONFIG_PATH, AppMode
import pla
...
print(f"Starting in {APP_MODE.name} mode")
config = json.load(open(CONFIG_PATH + 'config.json'))

if APP_MODE == AppMode.WEB or config["SeedCheckOnly"]:
...
@app.route("/seeds")
def seed():
    return render_template('pages/seeds.html')

@app.route("/spawns")
def alpha():
    return render_template('pages/spawns.html')

@app.route("/multiseed")
def multiseed():
    return render_template('pages/multiseed.html')
...
if APP_MODE != AppMode.WEB:
    ...
    def distortion():
        return render_template('pages/distortions.html')
    
    @app.route("/mmos")
    def mmo_checker():
        return render_template('pages/mmos.html')

    @app.route("/multis")
    def multi():
        return render_template('pages/multis.html')
